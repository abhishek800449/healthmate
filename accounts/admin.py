...
from .models import User, DoctorProfile, PatientProfile, Specialization, MedicalRecord, Country, State, City, Clinic, ClinicGallery, ReviewRating, Prescription, PrescriptionItem
